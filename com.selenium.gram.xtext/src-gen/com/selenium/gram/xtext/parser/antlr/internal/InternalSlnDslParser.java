...
public class InternalSlnDslParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_URL", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'main'", "'endmain'", "'sub'", "'endsub'", "'()'", "'('", "'var'", "','", "')'", "'sizeof'", "'->'", "'All'", "'Any'", "'verify'", "'exist'", "'!'", "'=='", "'<'", "'>'", "'='", "'if'", "'then'", "'else'", "'endif'", "'while'", "'do'", "'endwhile'", "'foreach'", "'in'", "'endfor'", "'click'", "'open'", "'check'", "'type'", "'select'", "'button'", "'image'", "'link'"
    };
    ...
    public final EObject ruleModel() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( (LA3_0==RULE_ID||LA3_0==32||LA3_0==36||LA3_0==39||(LA3_0>=42 && LA3_0<=45)) ) {
                    alt3=1;
                }
            ...
            otherlv_4=(Token)match(input,13,FOLLOW_13_in_ruleModel200); 
    ...
    public final EObject ruleSubprocedure() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,14,FOLLOW_14_in_ruleSubprocedure283); 
            ...
            do {
                ...
                if ( (LA5_0==RULE_ID||LA5_0==32||LA5_0==36||LA5_0==39||(LA5_0>=42 && LA5_0<=45)) ) {
                    alt5=1;
                }
            ...
            otherlv_4=(Token)match(input,15,FOLLOW_15_in_ruleSubprocedure360); 
        ...
        try {
            ...
            switch (alt7) {
                case 1 :
                    ...
                    otherlv_1=(Token)match(input,16,FOLLOW_16_in_ruleHead465); 
                ...
                case 2 :
                    ...
                    otherlv_3=(Token)match(input,17,FOLLOW_17_in_ruleHead506); 

                        	newLeafNode(otherlv_3, grammarAccess.getHeadAccess().getLeftParenthesisKeyword_1_1());
                        
                    otherlv_4=(Token)match(input,18,FOLLOW_18_in_ruleHead518); 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    otherlv_6=(Token)match(input,19,FOLLOW_19_in_ruleHead552); 

                    	        	newLeafNode(otherlv_6, grammarAccess.getHeadAccess().getCommaKeyword_1_4_0());
                    	        
                    	    otherlv_7=(Token)match(input,18,FOLLOW_18_in_ruleHead564); 
                    ...
                    otherlv_9=(Token)match(input,20,FOLLOW_20_in_ruleHead599); 
        ...
        try {
            ...
            switch (alt9) {
                case 1 :
                    ...
                    otherlv_1=(Token)match(input,16,FOLLOW_16_in_ruleFunctionCall885); 
                ...
                case 2 :
                    ...
                    otherlv_3=(Token)match(input,17,FOLLOW_17_in_ruleFunctionCall926); 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    otherlv_5=(Token)match(input,19,FOLLOW_19_in_ruleFunctionCall960); 
                    ...
                    otherlv_7=(Token)match(input,20,FOLLOW_20_in_ruleFunctionCall995); 
    ...
    public final EObject ruleListExpression() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,21,FOLLOW_21_in_ruleListExpression1672); 

                	newLeafNode(otherlv_0, grammarAccess.getListExpressionAccess().getSizeofKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleListExpression1684); 
            ...
            otherlv_3=(Token)match(input,20,FOLLOW_20_in_ruleListExpression1717); 
    ...
    public final EObject ruleBooleanListExpression() throws RecognitionException {
        ...
        try {
            ...
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleBooleanListExpression1821); 

                	newLeafNode(otherlv_1, grammarAccess.getBooleanListExpressionAccess().getLeftParenthesisKeyword_1());
                
            otherlv_2=(Token)match(input,18,FOLLOW_18_in_ruleBooleanListExpression1833); 
            ...
            otherlv_4=(Token)match(input,22,FOLLOW_22_in_ruleBooleanListExpression1866); 
            ...
            otherlv_6=(Token)match(input,20,FOLLOW_20_in_ruleBooleanListExpression1899); 
        ...
        try {
            ...
            switch (alt12) {
                case 1 :
                    ...
                    {
                    kw=(Token)match(input,23,FOLLOW_23_in_ruleBooleanListOperator1985); 
                ...
                case 2 :
                    ...
                    {
                    kw=(Token)match(input,24,FOLLOW_24_in_ruleBooleanListOperator2004); 
    ...
    public final EObject ruleVerifyAction() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,25,FOLLOW_25_in_ruleVerifyAction2291); 

                	newLeafNode(otherlv_0, grammarAccess.getVerifyActionAccess().getVerifyKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleVerifyAction2303); 
            ...
            otherlv_3=(Token)match(input,19,FOLLOW_19_in_ruleVerifyAction2336); 
            ...
            otherlv_5=(Token)match(input,20,FOLLOW_20_in_ruleVerifyAction2369); 
    ...
    public final EObject ruleExistAction() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,26,FOLLOW_26_in_ruleExistAction2452); 

                	newLeafNode(otherlv_0, grammarAccess.getExistActionAccess().getExistKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleExistAction2464); 
            ...
            otherlv_3=(Token)match(input,20,FOLLOW_20_in_ruleExistAction2497); 
    ...
    public final EObject ruleNegationExpression() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,27,FOLLOW_27_in_ruleNegationExpression2714); 
        ...
        try {
            ...
            switch (alt14) {
                case 1 :
                    ...
                    {
                    kw=(Token)match(input,28,FOLLOW_28_in_ruleBooleanOperator2821); 
                ...
                case 2 :
                    ...
                    {
                    kw=(Token)match(input,29,FOLLOW_29_in_ruleBooleanOperator2840); 
                ...
                case 3 :
                    ...
                    {
                    kw=(Token)match(input,30,FOLLOW_30_in_ruleBooleanOperator2859); 
    ...
    public final EObject ruleDefinition() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,18,FOLLOW_18_in_ruleDefinition3146); 
            ...
            otherlv_2=(Token)match(input,31,FOLLOW_31_in_ruleDefinition3179); 
    ...
    public final EObject ruleAssignation() throws RecognitionException {
        ...
        try {
            ...
            otherlv_1=(Token)match(input,31,FOLLOW_31_in_ruleAssignation3304); 
    ...
    public final EObject ruleConditional() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,32,FOLLOW_32_in_ruleConditional3408); 
            ...
            otherlv_2=(Token)match(input,33,FOLLOW_33_in_ruleConditional3441); 
            ...
            do {
                ...
                if ( (LA16_0==RULE_ID||LA16_0==32||LA16_0==36||LA16_0==39||(LA16_0>=42 && LA16_0<=45)) ) {
                    alt16=1;
                }
            ...
            switch (alt18) {
                case 1 :
                    ...
                    {
                    otherlv_4=(Token)match(input,34,FOLLOW_34_in_ruleConditional3476); 
                    ...
                    do {
                        ...
                        if ( (LA17_0==RULE_ID||LA17_0==32||LA17_0==36||LA17_0==39||(LA17_0>=42 && LA17_0<=45)) ) {
                            alt17=1;
                        }
            ...
            otherlv_6=(Token)match(input,35,FOLLOW_35_in_ruleConditional3512); 
    ...
    public final EObject ruleWhile() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,36,FOLLOW_36_in_ruleWhile3714); 

                	newLeafNode(otherlv_0, grammarAccess.getWhileAccess().getWhileKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleWhile3726); 
            ...
            otherlv_3=(Token)match(input,20,FOLLOW_20_in_ruleWhile3759); 

                	newLeafNode(otherlv_3, grammarAccess.getWhileAccess().getRightParenthesisKeyword_3());
                
            otherlv_4=(Token)match(input,37,FOLLOW_37_in_ruleWhile3771); 
            ...
            do {
                ...
                if ( (LA20_0==RULE_ID||LA20_0==32||LA20_0==36||LA20_0==39||(LA20_0>=42 && LA20_0<=45)) ) {
                    alt20=1;
                }
            ...
            otherlv_6=(Token)match(input,38,FOLLOW_38_in_ruleWhile3805); 
    ...
    public final EObject ruleForeach() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,39,FOLLOW_39_in_ruleForeach3888); 

                	newLeafNode(otherlv_0, grammarAccess.getForeachAccess().getForeachKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleForeach3900); 
            ...
            otherlv_3=(Token)match(input,40,FOLLOW_40_in_ruleForeach3933); 
            ...
            otherlv_5=(Token)match(input,20,FOLLOW_20_in_ruleForeach3966); 

                	newLeafNode(otherlv_5, grammarAccess.getForeachAccess().getRightParenthesisKeyword_5());
                
            otherlv_6=(Token)match(input,37,FOLLOW_37_in_ruleForeach3978); 
            ...
            do {
                ...
                if ( (LA21_0==RULE_ID||LA21_0==32||LA21_0==36||LA21_0==39||(LA21_0>=42 && LA21_0<=45)) ) {
                    alt21=1;
                }
            ...
            otherlv_8=(Token)match(input,41,FOLLOW_41_in_ruleForeach4012); 
    ...
    // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:1934:1: ruleActionClick returns [EObject current=null] : (otherlv_0= 'click' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')' ) ;
    public final EObject ruleActionClick() throws RecognitionException {
        ...
        try {
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:1937:28: ( (otherlv_0= 'click' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')' ) )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:1938:1: (otherlv_0= 'click' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')' )
            {
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:1938:1: (otherlv_0= 'click' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')' )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:1938:3: otherlv_0= 'click' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')'
            {
            otherlv_0=(Token)match(input,42,FOLLOW_42_in_ruleActionClick4268); 

                	newLeafNode(otherlv_0, grammarAccess.getActionClickAccess().getClickKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleActionClick4280); 

                	newLeafNode(otherlv_1, grammarAccess.getActionClickAccess().getLeftParenthesisKeyword_1());
                
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:1946:1: ( (lv_type_2_0= ruleClickableElement ) )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:1947:1: (lv_type_2_0= ruleClickableElement )
            {
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:1947:1: (lv_type_2_0= ruleClickableElement )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:1948:3: lv_type_2_0= ruleClickableElement
            {
             
            	        newCompositeNode(grammarAccess.getActionClickAccess().getTypeClickableElementParserRuleCall_2_0()); 
            	    
            pushFollow(FOLLOW_ruleClickableElement_in_ruleActionClick4301);
            ...
            otherlv_3=(Token)match(input,19,FOLLOW_19_in_ruleActionClick4313); 
            ...
            pushFollow(FOLLOW_ruleNumberLiteral_in_ruleActionClick4334);
            ...
            otherlv_5=(Token)match(input,20,FOLLOW_20_in_ruleActionClick4346); 
    ...
    public final EObject entryRuleActionOpen() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleActionOpen_in_entryRuleActionOpen4382);
            iv_ruleActionOpen=ruleActionOpen();

            state._fsp--;

             current =iv_ruleActionOpen; 
            match(input,EOF,FOLLOW_EOF_in_entryRuleActionOpen4392); 
    ...
    public final EObject ruleActionOpen() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,43,FOLLOW_43_in_ruleActionOpen4429); 

                	newLeafNode(otherlv_0, grammarAccess.getActionOpenAccess().getOpenKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleActionOpen4441); 
            ...
            {
            lv_url_2_0=(Token)match(input,RULE_URL,FOLLOW_RULE_URL_in_ruleActionOpen4458); 
            ...
            otherlv_3=(Token)match(input,20,FOLLOW_20_in_ruleActionOpen4475); 
    ...
    public final EObject entryRuleActionCheck() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleActionCheck_in_entryRuleActionCheck4511);
            iv_ruleActionCheck=ruleActionCheck();

            state._fsp--;

             current =iv_ruleActionCheck; 
            match(input,EOF,FOLLOW_EOF_in_entryRuleActionCheck4521); 
    ...
    // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2058:1: ruleActionCheck returns [EObject current=null] : (otherlv_0= 'check' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')' ) ;
    public final EObject ruleActionCheck() throws RecognitionException {
        ...
        try {
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2061:28: ( (otherlv_0= 'check' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')' ) )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2062:1: (otherlv_0= 'check' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')' )
            {
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2062:1: (otherlv_0= 'check' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')' )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2062:3: otherlv_0= 'check' otherlv_1= '(' ( (lv_type_2_0= ruleClickableElement ) ) otherlv_3= ',' ( (lv_element_4_0= ruleNumberLiteral ) ) otherlv_5= ')'
            {
            otherlv_0=(Token)match(input,44,FOLLOW_44_in_ruleActionCheck4558); 

                	newLeafNode(otherlv_0, grammarAccess.getActionCheckAccess().getCheckKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleActionCheck4570); 

                	newLeafNode(otherlv_1, grammarAccess.getActionCheckAccess().getLeftParenthesisKeyword_1());
                
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2070:1: ( (lv_type_2_0= ruleClickableElement ) )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2071:1: (lv_type_2_0= ruleClickableElement )
            {
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2071:1: (lv_type_2_0= ruleClickableElement )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2072:3: lv_type_2_0= ruleClickableElement
            {
             
            	        newCompositeNode(grammarAccess.getActionCheckAccess().getTypeClickableElementParserRuleCall_2_0()); 
            	    
            pushFollow(FOLLOW_ruleClickableElement_in_ruleActionCheck4591);
            lv_type_2_0=ruleClickableElement();
            ...
            otherlv_3=(Token)match(input,19,FOLLOW_19_in_ruleActionCheck4603); 
            ...
            pushFollow(FOLLOW_ruleNumberLiteral_in_ruleActionCheck4624);
            lv_element_4_0=ruleNumberLiteral();
            ...
            otherlv_5=(Token)match(input,20,FOLLOW_20_in_ruleActionCheck4636); 
    ...
    public final EObject entryRuleActionType() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleActionType_in_entryRuleActionType4672);
            iv_ruleActionType=ruleActionType();

            state._fsp--;

             current =iv_ruleActionType; 
            match(input,EOF,FOLLOW_EOF_in_entryRuleActionType4682); 
    ...
    public final EObject ruleActionType() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,45,FOLLOW_45_in_ruleActionType4719); 

                	newLeafNode(otherlv_0, grammarAccess.getActionTypeAccess().getTypeKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleActionType4731); 
            ...
            pushFollow(FOLLOW_ruleNumberLiteral_in_ruleActionType4752);
            lv_nameElement_2_0=ruleNumberLiteral();
            ...
            otherlv_3=(Token)match(input,19,FOLLOW_19_in_ruleActionType4764); 
            ...
            pushFollow(FOLLOW_ruleExpression_in_ruleActionType4785);
            lv_value_4_0=ruleExpression();
            ...
            otherlv_5=(Token)match(input,20,FOLLOW_20_in_ruleActionType4797); 
    ...
    public final EObject entryRuleActionSelectExpression() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleActionSelectExpression_in_entryRuleActionSelectExpression4833);
            iv_ruleActionSelectExpression=ruleActionSelectExpression();

            state._fsp--;

             current =iv_ruleActionSelectExpression; 
            match(input,EOF,FOLLOW_EOF_in_entryRuleActionSelectExpression4843); 
    ...
    public final EObject ruleActionSelectExpression() throws RecognitionException {
        ...
        try {
            ...
            {
            otherlv_0=(Token)match(input,46,FOLLOW_46_in_ruleActionSelectExpression4880); 

                	newLeafNode(otherlv_0, grammarAccess.getActionSelectExpressionAccess().getSelectKeyword_0());
                
            otherlv_1=(Token)match(input,17,FOLLOW_17_in_ruleActionSelectExpression4892); 
            ...
            pushFollow(FOLLOW_ruleExpression_in_ruleActionSelectExpression4913);
            ...
            otherlv_3=(Token)match(input,20,FOLLOW_20_in_ruleActionSelectExpression4925); 
    ...
    // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2246:1: entryRuleClickableElement returns [String current=null] : iv_ruleClickableElement= ruleClickableElement EOF ;
    public final String entryRuleClickableElement() throws RecognitionException {
        ...
        try {
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2247:2: (iv_ruleClickableElement= ruleClickableElement EOF )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2248:2: iv_ruleClickableElement= ruleClickableElement EOF
            {
             newCompositeNode(grammarAccess.getClickableElementRule()); 
            pushFollow(FOLLOW_ruleClickableElement_in_entryRuleClickableElement4962);
            iv_ruleClickableElement=ruleClickableElement();

            state._fsp--;

             current =iv_ruleClickableElement.getText(); 
            match(input,EOF,FOLLOW_EOF_in_entryRuleClickableElement4973); 
    ...
    // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2255:1: ruleClickableElement returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (kw= 'button' | kw= 'image' | kw= 'link' ) ;
    public final AntlrDatatypeRuleToken ruleClickableElement() throws RecognitionException {
        ...
        try {
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2258:28: ( (kw= 'button' | kw= 'image' | kw= 'link' ) )
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2259:1: (kw= 'button' | kw= 'image' | kw= 'link' )
            {
            // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2259:1: (kw= 'button' | kw= 'image' | kw= 'link' )
            int alt23=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt23) {
                case 1 :
                    // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2260:2: kw= 'button'
                    {
                    kw=(Token)match(input,47,FOLLOW_47_in_ruleClickableElement5011); 
                    ...
                    break;
                case 2 :
                    // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2267:2: kw= 'image'
                    {
                    kw=(Token)match(input,48,FOLLOW_48_in_ruleClickableElement5030); 
                    ...
                    break;
                case 3 :
                    // ../com.selenium.gram.xtext/src-gen/com/selenium/gram/xtext/parser/antlr/internal/InternalSlnDsl.g:2274:2: kw= 'link'
                    {
                    kw=(Token)match(input,49,FOLLOW_49_in_ruleClickableElement5049); 
    ...
    public static final BitSet FOLLOW_12_in_ruleModel144 = new BitSet(new long[]{0x00003C9100040010L});
    public static final BitSet FOLLOW_ruleDefinition_in_ruleModel165 = new BitSet(new long[]{0x00003C9100040010L});
    public static final BitSet FOLLOW_ruleInstruction_in_ruleModel187 = new BitSet(new long[]{0x00003C9100042010L});
    ...
    public static final BitSet FOLLOW_14_in_ruleSubprocedure283 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleHead_in_ruleSubprocedure304 = new BitSet(new long[]{0x00003C9100040010L});
    public static final BitSet FOLLOW_ruleDefinition_in_ruleSubprocedure325 = new BitSet(new long[]{0x00003C9100040010L});
    public static final BitSet FOLLOW_ruleInstruction_in_ruleSubprocedure347 = new BitSet(new long[]{0x00003C9100048010L});
    public static final BitSet FOLLOW_15_in_ruleSubprocedure360 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleFunctionName_in_ruleHead453 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_16_in_ruleHead465 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleFunctionName_in_ruleHead494 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleHead506 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_ruleHead518 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleVariableName_in_ruleHead539 = new BitSet(new long[]{0x0000000000180000L});
    public static final BitSet FOLLOW_19_in_ruleHead552 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_ruleHead564 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleVariableName_in_ruleHead585 = new BitSet(new long[]{0x0000000000180000L});
    public static final BitSet FOLLOW_20_in_ruleHead599 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleFunctionReference_in_ruleFunctionCall873 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_16_in_ruleFunctionCall885 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleFunctionReference_in_ruleFunctionCall914 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleFunctionCall926 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleFunctionCall947 = new BitSet(new long[]{0x0000000000180000L});
    public static final BitSet FOLLOW_19_in_ruleFunctionCall960 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleFunctionCall981 = new BitSet(new long[]{0x0000000000180000L});
    public static final BitSet FOLLOW_20_in_ruleFunctionCall995 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_21_in_ruleListExpression1672 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleListExpression1684 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleListExpression1705 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleListExpression1717 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleBooleanListOperator_in_ruleBooleanListExpression1809 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleBooleanListExpression1821 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_ruleBooleanListExpression1833 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleVariableName_in_ruleBooleanListExpression1854 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_22_in_ruleBooleanListExpression1866 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleBooleanListExpression1887 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleBooleanListExpression1899 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_23_in_ruleBooleanListOperator1985 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_24_in_ruleBooleanListOperator2004 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_25_in_ruleVerifyAction2291 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleVerifyAction2303 = new BitSet(new long[]{0x0000000000000060L});
    public static final BitSet FOLLOW_ruleNumberLiteral_in_ruleVerifyAction2324 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_ruleVerifyAction2336 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleVerifyAction2357 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleVerifyAction2369 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_26_in_ruleExistAction2452 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleExistAction2464 = new BitSet(new long[]{0x0000000000000060L});
    public static final BitSet FOLLOW_ruleNumberLiteral_in_ruleExistAction2485 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleExistAction2497 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_ruleBooleanOperator_in_ruleBinaryBooleanExpression2589 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleBinaryBooleanExpression2610 = new BitSet(new long[]{0x00007C917FA40070L});
    ...
    public static final BitSet FOLLOW_27_in_ruleNegationExpression2714 = new BitSet(new long[]{0x00007C917FA40070L});
    ...
    public static final BitSet FOLLOW_28_in_ruleBooleanOperator2821 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_29_in_ruleBooleanOperator2840 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_30_in_ruleBooleanOperator2859 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_18_in_ruleDefinition3146 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleVariableName_in_ruleDefinition3167 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_31_in_ruleDefinition3179 = new BitSet(new long[]{0x00007C917FA40070L});
    ...
    public static final BitSet FOLLOW_ruleVariableReference_in_ruleAssignation3292 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_31_in_ruleAssignation3304 = new BitSet(new long[]{0x00007C917FA40070L});
    ...
    public static final BitSet FOLLOW_32_in_ruleConditional3408 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleConditional3429 = new BitSet(new long[]{0x0000000200000000L});
    public static final BitSet FOLLOW_33_in_ruleConditional3441 = new BitSet(new long[]{0x00003C9100040010L});
    public static final BitSet FOLLOW_ruleInstruction_in_ruleConditional3462 = new BitSet(new long[]{0x00003C9D00040010L});
    public static final BitSet FOLLOW_34_in_ruleConditional3476 = new BitSet(new long[]{0x00003C9100040010L});
    public static final BitSet FOLLOW_ruleInstruction_in_ruleConditional3497 = new BitSet(new long[]{0x00003C9900040010L});
    public static final BitSet FOLLOW_35_in_ruleConditional3512 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_36_in_ruleWhile3714 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleWhile3726 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleWhile3747 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleWhile3759 = new BitSet(new long[]{0x0000002000000000L});
    public static final BitSet FOLLOW_37_in_ruleWhile3771 = new BitSet(new long[]{0x00003C9100040010L});
    public static final BitSet FOLLOW_ruleInstruction_in_ruleWhile3792 = new BitSet(new long[]{0x00003CD100040010L});
    public static final BitSet FOLLOW_38_in_ruleWhile3805 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_39_in_ruleForeach3888 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleForeach3900 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleVariableName_in_ruleForeach3921 = new BitSet(new long[]{0x0000010000000000L});
    public static final BitSet FOLLOW_40_in_ruleForeach3933 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleForeach3954 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleForeach3966 = new BitSet(new long[]{0x0000002000000000L});
    public static final BitSet FOLLOW_37_in_ruleForeach3978 = new BitSet(new long[]{0x00003C9100040010L});
    public static final BitSet FOLLOW_ruleInstruction_in_ruleForeach3999 = new BitSet(new long[]{0x00003E9100040010L});
    public static final BitSet FOLLOW_41_in_ruleForeach4012 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_42_in_ruleActionClick4268 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleActionClick4280 = new BitSet(new long[]{0x0003800000000000L});
    public static final BitSet FOLLOW_ruleClickableElement_in_ruleActionClick4301 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_ruleActionClick4313 = new BitSet(new long[]{0x0000000000000060L});
    public static final BitSet FOLLOW_ruleNumberLiteral_in_ruleActionClick4334 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleActionClick4346 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleActionOpen_in_entryRuleActionOpen4382 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleActionOpen4392 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_43_in_ruleActionOpen4429 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleActionOpen4441 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_RULE_URL_in_ruleActionOpen4458 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleActionOpen4475 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleActionCheck_in_entryRuleActionCheck4511 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleActionCheck4521 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_44_in_ruleActionCheck4558 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleActionCheck4570 = new BitSet(new long[]{0x0003800000000000L});
    public static final BitSet FOLLOW_ruleClickableElement_in_ruleActionCheck4591 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_ruleActionCheck4603 = new BitSet(new long[]{0x0000000000000060L});
    public static final BitSet FOLLOW_ruleNumberLiteral_in_ruleActionCheck4624 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleActionCheck4636 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleActionType_in_entryRuleActionType4672 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleActionType4682 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_45_in_ruleActionType4719 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleActionType4731 = new BitSet(new long[]{0x0000000000000060L});
    public static final BitSet FOLLOW_ruleNumberLiteral_in_ruleActionType4752 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_ruleActionType4764 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleActionType4785 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleActionType4797 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleActionSelectExpression_in_entryRuleActionSelectExpression4833 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleActionSelectExpression4843 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_46_in_ruleActionSelectExpression4880 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_ruleActionSelectExpression4892 = new BitSet(new long[]{0x00007C917FA40070L});
    public static final BitSet FOLLOW_ruleExpression_in_ruleActionSelectExpression4913 = new BitSet(new long[]{0x0000000000100000L});
    public static final BitSet FOLLOW_20_in_ruleActionSelectExpression4925 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ruleClickableElement_in_entryRuleClickableElement4962 = new BitSet(new long[]{0x0000000000000000L});
    public static final BitSet FOLLOW_EOF_in_entryRuleClickableElement4973 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_47_in_ruleClickableElement5011 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_48_in_ruleClickableElement5030 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_49_in_ruleClickableElement5049 = new BitSet(new long[]{0x0000000000000002L});
