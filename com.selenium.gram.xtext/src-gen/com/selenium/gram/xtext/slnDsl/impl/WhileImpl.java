 ...
 *   <li>{@link com.selenium.gram.xtext.slnDsl.impl.WhileImpl#getIns <em>Ins</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WhileImpl extends MinimalEObjectImpl.Container implements While
{
  ...
  public EList<Instruction> getIns()
  {
    if (ins == null)
    {
      ins = new EObjectContainmentEList<Instruction>(Instruction.class, this, SlnDslPackage.WHILE__INS);
    }
    return ins;
  }
